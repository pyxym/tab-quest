...
export const useAIStore = create<AIStore>((set, get) => ({
  ...
  addInsight: (insight) => ErrorBoundary.wrapSync(
    () => {
  ...
  removeInsight: (insightId) => ErrorBoundary.wrapSync(
    () => {
  ...
  setPatterns: (patterns) => ErrorBoundary.wrapSync(
    () => {
      // Validate patterns
  ...
  updatePattern: (patternId, updates) => ErrorBoundary.wrapSync(
    () => {
  ...
  setProductivityScore: (productivityScore) => ErrorBoundary.wrapSync(
    () => {
